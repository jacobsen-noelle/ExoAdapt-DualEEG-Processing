...
myMainOutDir= 'R:\Ferris-Lab\jacobsen.noelle\Exo Adaptation\Data\processed_data\';
outputFolder= strcat(myMainOutDir, datestr(now, 'yyyy-mm-dd'),'-Step4-IC Rejection\');
...
rawdataFolder = 'R:\Ferris-Lab\jacobsen.noelle\Exo Adaptation\Data\raw_data';
%setup paths
...
diary ON
subject_num = extractAfter(EEG.subject,'S'); subject_num = str2num(subject_num);
...
opt.fieldtrip_path = 'R:\Ferris-Lab\share\MindInMotion\fieldtrip-master'; 
opt.eeglab_path = eeglabpath;
...
%% estimate time remaining
    ...
    close all;
clearvars -except EEG fin count rawdataFolder EEGfileList eeglabpath subi EEGinputFolder tStart count outputFolder outputFolder2 X datasetinfo datasetinfo_folder outputFigureFolder outputFigureFolder2 L 
